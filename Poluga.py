...
class GameSprite(sprite.Sprite):
    def init(self, img, x, y, width, height, speed):
        super().init()
...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet("Hetmantic Ship2.png", self.rect.centerx, self.rect.y, 12, 25, 15)
        bullets.add(bullet)
...
background = transform.scale(image.load("space.jpeg"), (WIDTH, HEIGHT))

player = Player("Hetmantic Ship2.png", 320, 500, 70, 100, 5)
...
while game:
    ...
    if run:
        ...
        enemies.update()
        bullets.update()
        text = font2.render("Рахунок: " + str(0), True, (255, 255, 255))
